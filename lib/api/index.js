...
const searchMovie = ({queryKey:[,search], pageParam=1}) => instance.get("/search/movie?query="+search+"&page="+pageParam).then( res => res.data )
const searchTV = ({queryKey:[,search], pageParam=1}) => instance.get("/search/tv?query="+search+"&page="+pageParam).then( res => res.data )

export default api

export {getImage, getMovieByGenre, getTVByGenre, searchMovie, searchTV}